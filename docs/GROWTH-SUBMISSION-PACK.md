...
### 6.1 现成可用（在册 6 张，全部真机截图、已提交在仓内。★ 2026-09-25 批次 K 逐行复核：**1 张作废（学习流）、1 张待重拍（侧栏已从八项变六项）** ⇒ 现在真能对外用的 4 张）
...
| `docs/images/app-chat.png` | 1440×900 | 应用壳·对话（八视图侧栏 + 督促胶囊） | **主截图第 1 张**（一眼看得出是产品）。⚠️ **待重拍**：侧栏 2026-09-25 起是**六项**（学习流／知识图两项已删），这张图里的八项已是过去 |
