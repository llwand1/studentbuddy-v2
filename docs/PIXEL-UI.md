...
知识大陆的学习扩地、怪物侵占、战斗、老化及存档属于后续功能批。Avatar、卡牌数值和 XP/连签有各自事实源，视觉组件不能凭演出另算奖励。
...
本轮知识大陆已经支持词条地图、四题型复习挑战与图鉴，不再属于纯视觉预留；角色走位、扩地、历史副本与 Boss 联动仍待实现。卡牌保留既有稀有度、奖励账本与迁移，不另算一套游戏数值。
