...
| [`SEARCH-PROVIDER-SELECTION.md`](docs/SEARCH-PROVIDER-SELECTION.md) | 托管搜索 provider 选型册（Tavily／Exa／智谱 免费档·限速·端点形状对照；★ 含「`.env` 只配一家，因为三家是并行聚合」那条计费口径与落地判据） |
