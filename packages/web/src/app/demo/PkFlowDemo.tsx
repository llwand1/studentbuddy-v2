  ...
  return (
    <div className={stage === 0 ? 'ld-pk-hud ld-pk-in' : 'ld-pk-hud'}>
      ...
      <div className="ld-pk-topic">
        ...
        <span className="ld-pk-tn">圆周运动</span>
        <span className="ld-pk-to">对手的主题</span>
      </div>
  ...
  return (
    <div className="ld-pk-pending">
      <div className="ld-pk-p-head">
        ...
        <span className="ld-pk-p-text">对手正在出题</span>
        <span className="ld-pk-p-sec">{sec > 0 ? `已过 ${sec}s` : '马上就好'}</span>
      </div>
      ...
      <p className="ld-pk-hint">题目一出来就自动出现在这里，不用刷新</p>
    </div>
  );
}
...
function Verdict() {
  return (
    <div className="ld-pk-verdict correct">
      ...
      <span className="ld-pk-v-text">答对 +2</span>
      <span className="ld-pk-v-gone">2.5s 后自动消失</span>
    </div>
  );
}
...
function Result() {
  return (
    <div className="ld-pk-result">
      ...
      <div className="ld-pk-r-t">这局你赢了</div>
      <div className="ld-pk-r-reason">对手投降 · 终局判定</div>
      <div className="ld-pk-r-score">
        <div className="ld-pk-r-side">
          <span className="ld-pk-nm">对手</span>
          <span className="ld-pk-num">1</span>
          <span className="ld-pk-sub">答对 1/3</span>
        </div>
        <div className="ld-pk-r-side won">
          <span className="ld-pk-nm">我</span>
          <span className="ld-pk-num">5</span>
          <span className="ld-pk-sub">答对 2/3</span>
        </div>
      </div>
    </div>
  );
      ...
      <div className="ld-pk-body">
        {(stage === 0 || stage === 1) && (
          <div className="ld-pk-bubble">
            <span>我发出的出题请求：用「受力分析」出道单选题，别太简单</span>
          </div>
        )}
        {stage === 1 && <Pending />}
        {stage === 2 && <Question />}
