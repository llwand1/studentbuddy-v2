# StudentBuddy 项目导览：该怎么看本项目

> 版本：v1.1（2026-09-25，原 `INTERVIEW.md` 更名中性化）| 状态：[活跃] | 面向：第一次打开这个仓库的人（评审 / 潜在协作者 / 未来的自己）
>
...
>
> ⚠️ 一句话声明：本文档不为任何场合编造"标准答案"。每个 trade-off 写的是**当时真实选了什么、
> 为什么、代价是什么、什么时候会换**。
